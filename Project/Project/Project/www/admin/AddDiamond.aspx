...
<%--                    <asp:ListItem Value="0">Select a shape for the stone</asp:ListItem>
...
<%--                    <asp:ListItem>Select a lab for the stone</asp:ListItem>
        ...
        <tr>
            <td>Status:</td>
            <td>
                <asp:RadioButtonList ID="Status_RBL" runat="server" DataSourceID="SqlDataSource11" DataTextField="Status_Name" DataValueField="Status_Name">
                </asp:RadioButtonList>
                 <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" SelectCommand="SELECT [Status_Name] FROM [Status]"></asp:SqlDataSource>
            </td>
            <td>
